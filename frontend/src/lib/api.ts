...
export const constituenciesApi = {
  list: () => fetchApi<any[]>("/api/constituencies"),
};
...
export const projectsApi = {
  list: (params?: { page?: number; limit?: number; sector?: string; status?: string; priority?: string; search?: string; sortBy?: string; sortOrder?: "asc" | "desc"; }) =>
